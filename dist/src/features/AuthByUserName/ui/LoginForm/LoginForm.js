...
var LoginForm = memo(function (_a) {
    ...
    return (_jsx(DynamicModuleLoader, __assign({ removeAfterUnmount: true, reducers: initialReducers }, { children: _jsxs("div", __assign({ className: classNames(cls.loginForm, {}, [className]) }, { children: [_jsx(Text, { title: t('Форма Авторизации') }, void 0), _jsx(Input, { autofocus: true, type: "text", placeholder: t('Логин'), onChange: onChangeUsername, value: username }, void 0), _jsx(Input, { type: "password", placeholder: t('Пароль'), onChange: onChangePassword, value: password }, void 0), error && (_jsx(Text, { theme: TextTheme.ERROR, text: t('Неверный логин или пароль') }, void 0)), _jsx(Button, __assign({ disabled: isLoading, theme: ButtonTheme.BACKGROUND_INVERTED, onClick: onLoginClick }, { children: t('Войти') }), void 0)] }), void 0) }), void 0));
});
