...
export var ArticleDetails = function (_a) {
    ...
    var fetchData = function (id) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, dispatch(fetchArticleById({ id: id }))];
                case 1:
                    resultData = _a.sent();
    ...
    return (_jsx(DynamicModuleLoader, __assign({ reducers: reducers, removeAfterUnmount: true }, { children: _jsx("div", __assign({ className: classNames(cls.articleDetails, {}, [className]) }, { children: "ArticleDetails" }), void 0) }), void 0));
};
